...
import MindSpotIntroModal from "./MindSpotIntroModal";
...
const Hero = () => {
  ...
  return (
    <>
      <MindSpotIntroModal open={introOpen} onClose={() => setIntroOpen(false)} />
          ...
          <div className="max-w-2xl">
            ...
            >
              ...
              <Button
                variant="outline"
                size="lg"
                className="text-base px-8 gap-2 border-primary/40 hover:border-primary hover:bg-accent transition-all"
            ...
            >
              ...
              {stats && stats.therapistCount > 0 && (
                <span className="flex items-center gap-1.5">
                  <Shield size={14} className="text-primary shrink-0" />
                  {t("hero.professionals", { count: stats.therapistCount })}
                </span>
              )}
              {stats && stats.avgRating > 0 && stats.reviewCount > 0 && (
                <span className="flex items-center gap-1.5">
                  <Shield size={14} className="text-primary shrink-0" />
                  {t("hero.avgRating", { rating: stats.avgRating.toFixed(1), count: stats.reviewCount })}
                </span>
              )}
            </motion.div>
          </div>
