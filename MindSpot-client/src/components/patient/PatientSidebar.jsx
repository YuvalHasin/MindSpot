...
const PatientSidebar = () => {
  ...
  const links = [
    { to: "/patient-dashboard",          icon: LayoutDashboard, label: t("sidebar.overview") },
    { to: "/patient-dashboard/triage",   icon: ShieldCheck,     label: t("sidebar.newSession") },
    { to: "/patient-dashboard/sessions", icon: History,         label: t("sidebar.sessionHistory") },
    { to: "/patient-dashboard/settings", icon: UserCog,         label: t("sidebar.profileSettings") },
    { to: "/patient-dashboard/security", icon: ShieldCheck,     label: t("sidebar.security") },
  ];
      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-border bg-sidebar text-sidebar-foreground min-h-screen p-5 gap-2">
        <header className="border-b border-border bg-background/80 backdrop-blur-md px-4 py-3 flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground italic">{t("sidebar.portal")}</p>
          </div>
        </header>
